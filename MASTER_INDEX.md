...
| Vision Language Models | [NVlabs/VILA](https://github.com/sureshsolannki-ai/VILA) | `ai-research/VILA` | Edge VLM for on-site biochar batch QA (color, granularity, kiln residue) | Med |
| Vision Language Models | [QwenLM/Qwen3-VL](https://github.com/sureshsolannki-ai/Qwen3-VL) | `ai-research/Qwen3-VL` | Multimodal doc extraction (invoices, calibration certs, verifier reports; multilingual) | Med |
| Vision Language Models | [LLaVA-VL/LLaVA-NeXT](https://github.com/sureshsolannki-ai/LLaVA-NeXT) | `ai-research/LLaVA-NeXT` | Open VLM lineage baseline for reproducibility checks | Med |
...
| Deeptech / General AI infrastructure | [ollama/ollama](https://github.com/sureshsolannki-ai/ollama) | `ai-research/ollama` | Local LLM runtime for offline/edge (Akshaya Dhara rural, air-gapped verifier tools) | **High** |
| Deeptech / General AI infrastructure | [vllm-project/vllm](https://github.com/sureshsolannki-ai/vllm) | `ai-research/vllm` | Server-side LLM serving for centralized chamelion.ai workflows | Med |
| Deeptech / General AI infrastructure | [ray-project/ray](https://github.com/sureshsolannki-ai/ray) | `ai-research/ray` | Distributed compute for batch evidence-pipeline jobs | Med |
...
| AI Foundation | [huggingface/transformers](https://github.com/sureshsolanki-labs/transformers) | `ai-research/transformers` | Foundation model library; VLM/LLM benchmarks, tokenizers, adapters | **High** |
| AI Foundation | [pytorch/pytorch](https://github.com/sureshsolanki-labs/pytorch) | `ai-research/pytorch` | Underlying DL framework for VLM / biochar-property / geospatial ML. **⚠ NOASSERTION (BSD-3-style + patent grant)** | **High** |
...
| Audio & Speech | [openai/whisper](https://github.com/sureshsolanki-labs/whisper) | `ai-research/whisper` | ASR (speech-to-text) for Akshaya Dhara rural voice-capture and verifier-call transcription | **High** |
...
- **Domain consolidation (2026-07-04):** three original domains — Sustainability / Carbon, LCA & Materials, and Climate & Geospatial AI — merged into a single **Sustainability & Climate** domain. `whisper` moved from Vision Language Models to a new **Audio & Speech** domain (whisper is ASR, not a VLM). Final domain count: **10**.
